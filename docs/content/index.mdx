---
description: 'The architect-level guide for running Kubernetes in hybrid and on-premise environments.'
---
# Introduction
...
doesn't cover high-availability, security, maintenance procedures, threat models,
best practices, etc. And this book does! It's also useful as an advancement of
