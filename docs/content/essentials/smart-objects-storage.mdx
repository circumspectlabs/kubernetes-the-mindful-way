...
[Finite State Machines](/en/essentials/finite-state-machines), this article
...
attributes of an object. Please read more about finite state machines in [another topic](/en/essentials/finite-state-machines).
